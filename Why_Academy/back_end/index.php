...
<div class="content-wrapper">
    <div class="container">
            ...
            <div class="col-md-12">
                <h4 class="page-head-line">Please Login To Enter
                    <a href="admin/index.php">
                        <button style="margin-left:900px;" type="submit" name="submit" class="btn btn-secondary"><span
                                    class="glyphicon glyphicon-user"></span>Staff Log In
                        </button>
                    </a>
        ...
        <div class="col-sm-6 " style="padding-left!important;: 10px">
            <img src="includes/welcome.svg" alt="welcome svg" height="40%" width="85%">
